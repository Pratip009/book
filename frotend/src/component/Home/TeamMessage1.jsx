      ...
      <div className="row align-items-center">
        <div className="col-md-8">
          ...
          <Suspense fallback={<div>Loading...</div>}>
            <img src={starIcon} alt="Star Icon" className="icon star-icon" loading="lazy" />
            <img src={rocketIcon} alt="Rocket Icon" className="icon rocket-icon" loading="lazy" />
            <img src={bookIcon} alt="Book Icon" className="icon book-icon" loading="lazy" />
            <img src={planetIcon} alt="Planet Icon" className="icon planet-icon" loading="lazy" />
          </Suspense>
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <img src={chatBubblesIcon} alt="Chat Bubbles Icon" className="chat-bubbles-icon" loading="lazy" />
        </div>
      </div>
    </div>
  );
