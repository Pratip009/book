...
//   .post(isAuthentictedUser, authorizeRoles("admin"), uploadFiles, createProduct);
// router.route("/admin/product/:id").put(isAuthentictedUser, authorizeRoles("admin"), uploadFiles, updateProduct);
