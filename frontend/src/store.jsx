...
import { teamReducer } from "./reducers/teamReducer"; // Import the team reducer
...
const rootReducer = combineReducers({
  ...
  team: teamReducer, // Added teamReducer here
});

// Get all Cart values from local storage and pass this initial state into the store
let initialState = {
  cart: {
